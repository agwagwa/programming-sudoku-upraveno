Public Class SudokuPuzzle
    ...
    '==================================================
    Private Function CalculatePossibleValues(
                        ...
                        For cccc As Integer = 1 To 9
                            If actual(cccc, r) = 0 AndAlso Not cols.Contains(cccc) Then
                                ...
                                If possible(cccc, r).Length = 1 Then
                                    actual(cccc, r) = CInt(possible(cccc, r))
                                    totalscore += 5
                                End If
                            End If
                        Next
                        ...
                        For rrrr As Integer = 1 To 9
                            If actual(rrrr, c) = 0 AndAlso Not rows.Contains(rrrr) Then
                                ...
                                If possible(c, rrrr).Length = 1 Then
                                    actual(c, rrrr) = CInt(possible(c, rrrr))
                                    totalscore += 5
                                End If
                            End If
                        Next
                            ...
                            For cc As Integer = startC To startC + 2
                                ...
                                If actual(cc, rr) = 0 AndAlso Not cells.Contains(New CellPos(cc, rr)) Then
                                    ...
                                    If possible(cc, rr).Length = 1 Then
                                        actual(cc, rr) = CInt(possible(cc, rr))
                                        totalscore += 5
                                    End If
                                End If
                            Next
    ...
    '=========================================================
    Private Sub FindCellWithFewestPossibleValues(
    ...
    '============================================================
    Private Function RandomNumber(ByVal min As Integer,
    ...
    Private Function GenerateNewPuzzle(
       ...
       ByRef score As Integer) As String
        ...
        Select Case level
            ...
            Case 4 : numberofemptycells = RandomNumber(54, 60)
        End Select
    ...
    Private Sub VacateAnotherPairOfCells(ByRef str As String)
        ...
        str = str.Insert((10 - c - 1) + (10 - r - 1) * 9,
